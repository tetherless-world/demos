...
export CSV2RDF4LOD_BASE_URI="http://demo.tw.rpi.edu"
...
export CSV2RDF4LOD_PUBLISH_VC_REPOSITORY="git@github.com:tetherless-world/demos.git"
...
export CSV2RDF4LOD_PUBLISH_OUR_SOURCE_ID="tw"
...
export CSV2RDF4LOD_PUBLISH_VIRTUOSO_SPARQL_ENDPOINT="http://demo.tw.rpi.edu/sparql"
...
export CSV2RDF4LOD_PUBLISH_SPARQL_ENDPOINT="http://demo.tw.rpi.edu/sparql"
...
export CSV2RDF4LOD_PUBLISH_DATAHUB_METADATA_OUR_BUBBLE_ID="twc-demos"
...
export DATAFAQS_BASE_URI="http://demo.tw.rpi.edu"
